...
3. **Discord channel gating** — Consolidator script abandoned. Agent now lives in open channels: `1514323670628040835` (main) + `1529527246266695922` (chatter). Strict channel gating approach adopted.
4. **Chatter concept** — Auto-creating group chats from transcripts with automatic syncing. Chatter channel `1529527246266695922` now open. No separate chatter agent — founder agent owns chatter. Conv: `conv-2add1ebd-72d6-42e8-a54b-84345c951ebf`.
5. **Drops pipeline modernization** (July 22, 2026):
   - Drop Agent (`agent-82720585`, accountId `72c97142`): enabled but no open channels (functionally dormant on Discord). Will use webhook for #drops channel.
   - Transcript Agent (`agent-88845acf`, accountId `99a4f059`): open channel `1529527179304763565` (transcripts). Conv: `conv-3a8a28c9-d543-4aca-a92d-ecb6f61f1e8c`. Will pick up transcripts from Discord → analyze → send to Drop Agent.
