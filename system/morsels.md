---
description: Instructions for creating morsels - horizontal presentation decks distinct
  from tidbits. Includes format, content guidelines, features, and technical specs.
---
