---
description: Shared memory block for tracking founder tasks/deadlines with one-click
  Google Calendar integration. Stores task name, deadline, and auto-generated calendar
  links for easy addition to founder calendars.
---
