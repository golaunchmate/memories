...
- Pivoted to: Recruiting + social platform
- Why: AI will make skill feedback free; hard part is discovery and sharing

**SIGNATURE FEATURE: FIFA-Style Attributes**
- Speed, vision, strength, endurance visualization
- Skills breakdown (strengths, weaknesses, tendencies)
- "Best fit system" recommendation
- Jailyn: "This is the coolest thing I've ever seen as far as soccer goes"
...
2. Build player inventory before coach side
3. Get "wow" reaction from 10 real players
4. Don't validate with paying customers yet (frontier territory)

**Explicit Commitments (March 26):**
| What | By When |
|------|---------|
| Populate profiles with 10 real players (pros or themselves) | Next session |
| Get "wow" reaction from friends who play soccer | Next session |
| Try Gemini for video analysis | This week |
| Research computer vision companies for sports | This week |
| Max out Lovable credits for MVP, then move to Cursor | Ongoing |

**Technical Approach:**
- Gemini for video analysis (best multimodal/video)
- Computer vision for player tracking (Craig shared example)
- Cursor for development (SDSU free Pro version)
...
- Will Gemini work for video analysis?
- Will they focus on player side first?


## FOUNDER CONTEXT

**Template for each founder:**

### [Founder Name] - [Startup Name]
- Business Summary: [One-line description]
- Stage: [Idea / Validation / Building / Scaling]
- Current Blockers: [What's stuck]
- Active Experiments: [What they're testing now]
- Goals: [Short-term and long-term]
- Last Check-in: [Date and momentum score]
- Open Action Items: [Pending tasks]
- Mentor Sharing Permissions: [What can be shared with mentor]

**This data is pulled from each Founder's Agent before processing transcripts.**
...
- "US is replace vs repair economy" - people don't fix, they replace
- Confirmed: Focus on boat people is correct pivot
- Everyday people: "I don't have anything worth fixing vs replacing"

**Fix It Fair Learnings (March 20):**
- 4 demos, 30 min each, engineering courtyard
- Thicker fiber takes more resin, needs more expertise
- Product aspects need improvement for non-experts
- Car community mentioned as potential, but aesthetics-focused people may not want visible repairs

**NEW OPPORTUNITY: Freedom Boat Club (March 20):**
- Membership-based boat rental (Mission Bay, Chula Vista, multiple locations)
- Each location likely has own repair shop
- HIGH incentive to keep fleet running (lost revenue when boats down)
- Enterprise B2B angle vs individual boat owners
...
**Watch:**
- Will he hit 10 marina visits by next Friday?
- Will Freedom Boat Club be a better customer than individual boat owners?
- Will boatyard guy actually use the updated kit?

### Paige (Student Team Member)
- Role: LaunchMate development team (onboarding, agent training, meta-agent development)
- Current Focus: Cohort Factory meta-agent + pre-training agents for In-Flight founders
- Agent ID: agent-297cd755-05a5-421f-8d2b-5fc34a9282e7
- Energy: Execution mode, decisive, "figure it out by doing"
...
- Open Questions:
  ...
  - How to merge "soul-seeing" with "immediate needs"?
  - Michael's skills architecture integration?
- Next Follow-up Hooks:
...
- Patrick Collison sat with first 200 Stripe customers personally
- "I will not leave your side until I get you up and running"
- Zach must GO TO LAWYERS' OFFICES and install himself
...
- Get lawyers using the tool by next week (Collison installation method)
- Reframe pitch (don't start with "do you use AI?")
- Add checkout flow to website
- Update website messaging ("Privacy layer for AI")
- Go live with $7.99/month pricing
- Send tool to Craig's wife (attorney) for testing

**IMPLICIT COMMITMENTS (Feb 20):**
- Stop talking about architecture (confuses people)
- Stop waiting for Chrome Web Store (install manually)
- Test 30-day shutdown question ("If I took this away, would you be upset?")
- Consider freemium model (Grammarly approach)

**Current Blockers:**
- Chrome Web Store approval (waiting instead of installing)
- No checkout flow (can't capture intent)
- Wrong pitch (triggers defensiveness)
- Confusing messaging
- Lawyer denial (they don't think they need it)

**MARCH 20 UPDATE - ENTERPRISE LEAD:**
- NEW CUSTOMER SEGMENT: Instar Asset Management (cold outreach!)
- Want to integrate Sonomos into HR and administrative work
- NOT a lawyer - enterprise HR/admin use case emerging
- This could expand TAM significantly

**Current Blockers (March 20):**
- Firefox and Edge store rejections (still Chrome Web Store only)
- Trying to automate via CI/CD pipeline
...
- Will Instar Asset Management convert to pilot?
...
**Program Status:** In-Flight with flexible Friday attendance (skip weeks if not helpful, ping Craig in advance)

**Explicit Commitments (Feb 18):**
- Get conversion data from Cluck and Sip (Feb 21)
- Launch CoCo Curry (Feb 23)
- Secure cafe by March 27
- Practice systems-level business model articulation

**Follow-up Hooks:**
- Did Cluck and Sip show measurable conversion? How many students redeemed?
- CoCo Curry launch results?
- Is she articulating business model at strategic level now?

### Jai & Satith - AI Game Generation (Live In The Future Track)
- Business Summary: AI-generated 3D game worlds with dynamic NPC interactions (Infocom-style narratives)
- Stage: Building/Validation (have working prototype, testing dynamic NPC chat system)
...
- NPCs with hidden personality + public-facing persona (Infocom-style)
- NEW: Dynamic chat box interactions (replacing pre-generated dialogue trees)
- LLM calls during gameplay (NPCs have memory state, track player interactions)

**Key Innovation Identified (Feb 18):**
- Craig identified they've found an UNSOLVED problem: How to stitch AI into game logic, item layers, quest narratives
- Marc Andreessen (a16z) posted about same problem: "This integration feels as complex as the rest of the entire engine"
- Opportunity: Become "best way to add AI NPCs to existing games" (API/library for Unity, Roblox, etc.)

**Emotional Blocker:**
- Jai lacks enthusiasm ("Honestly, no. I don't feel like [this is exciting]")
- Both quick to dismiss their work as "not innovative" ("there's no technical moat")
- Craig coaching: "Innovation is staking out real estate and building feedback loops faster than anyone else"

**Explicit Commitments (Feb 18):**
- Ship desktop app for user prompting in 7-10 days (beta test with 20 users)
- Implement dynamic chat box NPC interactions (LLM calls during gameplay)
- Satith: Deploy model to cloud (reduce API costs)
- Continue another week on narrative enhancement

**Implicit Commitments (Feb 18):**
- Explore context-driven gameplay (pull Steam/Epic profile data, local files, personal context)
- Research API/library approach (plug NPCs into existing games vs. full game generation)
- Email Marc Andreessen when beta ready (open door to a16z network)
...
- Will they get EXCITED about this problem space? (Or continue feeling "meh"?)
- Will they pivot to API/library model vs. full game generation?
...
**Tiger Woods Framework:**
- Billy = Tiger Woods
- Billy's job = Golfing (being present with clients, delivering experiences)
- Build infrastructure around everything else

**Explicit Commitments (Feb 20):**
- Remove vendors from website (make pure intake form)
- Fix form submissions (currently "go ghost")
- Send website proactively ("when's your birthday?")
- Get business cards with QR code
- Record a night with Granola app (transcribe "life of Billy")
- Continue using LaunchMate for workflow optimization

**Implicit Commitments (Feb 20):**
- Maintain "Billy magic" personal touch (DON'T optimize away the brand)
- Capture guest list contacts into CRM for future monetization
- Build system for post-service follow-up (thank you messages)

**MARCH 20 UPDATE - DEMAND OVERWHELMING:**
- Business BOOMING - clients flooding in
- Instagram DMs growing, word of mouth accelerating
- Website working but clients bypassing it - "They want Billy"
- 2 people filled form, rest went direct to phone/text
- "Loss of productivity because of increased demand IS your business problem"

**Key Tension (March 20):**
- Website was supposed to help scale, but clients feel "pushed away" by form
- Forms create friction - people prefer chat or direct conversation
...
- "Whatever you do, maintain the customer experience, even if you need to not take on some business while scaling."

**Group Suggestions (March 20):**
- Variable pricing: Premium for high-touch Billy, lower tier for AI/chatbot
- "Chat with Billy" button: Feels more personal than form
- Say NO more: Drive up premium by being selective
- Record calls: Use Granola to capture intake data automatically

**Watch:**
- Will he work with Laura on chatbot alternative?
- Will he try Granola for call recording?
- Will he raise prices / say no to lower-value requests?
...
**EXPLICIT COMMITMENTS (Feb 20):**
- Plan more dates (focus on intake process)
- Be available during date night (text check-ins, "shadow concierge")
- Stay open-minded about pain points (write them down, don't be married to "tidbits")
- Send transcripts to Neal (Craig + Kathy interviews, email directly)
- Try Claude Skill (Ben Shapiro recommendation, less hallucination)
- Convert Craig to actually BOOK the date
- Feed intake transcripts into AI (screenshots of text conversations)
- Put ticket price on March 14 event

**IMPLICIT COMMITMENTS (Feb 20):**
- Discover what his real value is (not the plan, the intake)
- Stay involved all the way through the date (not just hand off PDF)
- Figure out if this is a $50/month business
- Consider group chat model (collaborative planning)

**Watch:**
- Will he convert Craig to actually go on the date?
- Will he stay involved through date night?
- Will he let go of "tidbits" and focus on intake process?
- Will he put ticket price on March 14 event?
- Will he build relationship model or try to automate too early?