---
description: Agent IDs for mentors and founders organized by cohort. Use for messaging and cross-references. For categorized agents with usage stats, see [[reference/agent_catalog]]. For quick name-to-ID lookup, see [[reference/agent_registry]].
---
Mentors
